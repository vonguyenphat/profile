         ...
         <div className='sm:grid grid-cols-1 sm:grid-cols-2 '>
            <div className='flex flex-col items-center sm:block'>
               <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold text-center sm:text-left">
                  <span className="bg-gradient-to-r from-green-400 to-[#a855f7] bg-clip-text text-transparent ">
                     Hello, I&apos;m{" "}
                  </span>
                  <br />
                  <TypeAnimation
               ...
               <div>
                  <Link
                     href="/#contact"
                     className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-r from-green-400 to-[#a855f7] hover:bg-slate-200 text-white text-center sm:text-left">
                     Hire Me
                  </Link>
                  <Link
                     href="/"
                     className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-green-400 to-[#a855f7] hover:bg-slate-800 text-white mt-3 text-center sm:text-left">
